...
const contractABI = require("../artifacts/contracts/Dappscaffold.sol/Dappscaffold.json").abi;

program
    .name("dappscaffold-cli")
    .description("CLI tool for Dappscaffold smart contract")
    .version("1.0.0");
